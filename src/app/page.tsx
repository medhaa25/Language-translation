...
const Home: React.FC = () => {
  ...
  // Get the translated text using the custom hook
  const targetText = useTranslate(sourceText, selectedLanguage);

  // Effect to log the values for verification
  useEffect(() => {
    console.log("Source Text:", sourceText);
    console.log("Selected Language:", selectedLanguage);
    console.log("Target Text:", targetText); // Log the translated text
  }, [sourceText, selectedLanguage, targetText]);
            ...
            <div className="mt-7 sm:mt-12 mx-auto max-w-3xl relative">
              <div className="grid gap-4 md:grid-cols-2 grid-cols-1">
                ...
                <div className="relative z-10 flex flex-col space-x-3 p-3 border rounded-lg shadow-lg bg-neutral-900 border-neutral-700 shadow-gray-900/20">
                  <TextArea
                    id="target-language"
                    value={targetText} // Ensure targetText is displayed here
